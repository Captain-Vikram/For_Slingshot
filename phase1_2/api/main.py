...
try:
    ...
    from phase1_2.shared.utils import normalize_label_mode
    from phase1_2.shared.config import load_config, ConfigManager
...
app = FastAPI(title="Omni-sight API", version="0.1.0")
