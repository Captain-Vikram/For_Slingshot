...
The Phase1&2 API system manages long-running jobs (collect, label, train, etc.) via a job queue system. To ensure reliability and performance, specifically regarding job status monitoring and log streaming, the following design patterns are implemented:
