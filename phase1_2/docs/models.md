...
| -------------------- | ---------- | ----------- | --------- | --------- | ----------------------------------------------- |
| **gemini-2.5-flash** | low        | low         | fast      | very good | **default** — best out-of-box path              |
| gemini-1.5-pro       | medium     | medium      | medium    | high      | stronger reasoning on complex scenes            |
| **gpt-5-nano**       | cheapest   | cheapest    | fastest   | good      | openai fallback for high-volume labeling        |
