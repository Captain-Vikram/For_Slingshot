...
def train_model(
    ...
    # Prevent outbound version checks from breaking training in restricted/offline networks.
    os.environ.setdefault("YOLO_OFFLINE", "true")

    try:
        from ultralytics.utils import checks as yolo_checks

        yolo_checks.check_pip_update_available = lambda *args, **kwargs: None
